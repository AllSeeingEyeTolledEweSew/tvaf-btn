...
class IterFilesTest(unittest.TestCase):
    ...
    def test_multi_file(self):
        ...
        self.assertEqual(f.full_path_bytes,
    ...
    def test_pad(self):
        ...
        self.assertEqual(f.full_path_bytes, [b"parent", b".pad", b"384"])
    ...
    def test_multi_file_attr(self):
        ...
        self.assertEqual(f.full_path_bytes, [b"parent", b"directory", b".sig"])
    ...
    def test_symlink(self):
        ...
        self.assertEqual(f.full_target_bytes,
                         [b"parent", b"directory", b"file.zip"])
