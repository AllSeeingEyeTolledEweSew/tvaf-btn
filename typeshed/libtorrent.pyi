...
class file_storage:
    ...
    def add_file(self, path:str, size:int, flags:int=..., mtime:int=...,
            linkpath:str=...) -> None: ...
...
class torrent_info:
    ...
    def is_valid(self) -> bool: ...
    def map_block(self, piece: int, offset: int, size: int) -> List[file_slice]: ...
...
class torrent_handle:
    ...
    def add_piece(self, index:int, data:bytes, flags:int) -> None: ...
    ...
    def force_reannounce(self, seconds:int=..., tracker_idx:int=...,
            flags:int=...) -> None: ...
    ...
    def connect_peer(self, endpoint:Tuple[str, int], source:int=..., flags:int=...) -> None: ...
...
class session:
    ...
    def dht_put_mutable_item(self, private_key:str, public_key:str, data:str,
            salt:str) -> None: ...
    ...
    def dht_sample_infohashes(self, ep:Tuple[str, int], target:sha1_hash) -> None: ...
    @overload
    ...
    def remove_torrent(self, handle:torrent_handle, option:int=...) -> None: ...
    ...
    def get_cache_info(self, handle:torrent_handle=..., flags:int=...) -> cache_status: ...
    def add_port_mapping(self, t:portmap_protocol, external_port:int, local_port:int) -> List[int]: ...
    ...
    def set_peer_class_type_filter(self, f:peer_class_type_filter) -> None: ...
...
def write_resume_data(atp:add_torrent_params) -> _Entry: ...
